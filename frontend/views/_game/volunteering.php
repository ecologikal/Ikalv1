<div class="element <?php  echo $randtypeclass .' '. $randpetalclass; ?> ">
	...
	<div id="titlecontainer">
		...
		</div>"Net Zero Homes - A Journey Toward Energy Self-Sufficiency <a href="http://goo.gl/2SvM9" target="_blank">http://goo.gl/2SvM9</a>"</div>
	<div id="content">
		<div id="link">
	...
	<div id="box">
		<div class="boxcontent">
			...
			<div id="commentbutton" onclick="$('a.comment').trigger('click');" class="<?php echo $petals[$randpetal]['Color']; ?>_bg"><a href="<?php echo _ROOT_URL_ ?>comment.php?userid=0&commentid=0"class="comment iframe">Comment</a></div>
