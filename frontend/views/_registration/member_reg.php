...
<div id="forma_registro" title="Registro">
	<h1>Join Ecologikal</h1>
	<p>You are about to join to the network that will redefine the way you travel and live. </p>
	<h4>With ecologikal the world is your classroom!</h4>
	<form>
	<fieldset>
		<label for="miembro_forma_registro_usuario">Choose a Username</label>
		...
		<label for="miembro_forma_registro_contrasena">Choose a Password</label>
		...
		<label for="miembro_forma_registro_email">Type your E-mail</label>
