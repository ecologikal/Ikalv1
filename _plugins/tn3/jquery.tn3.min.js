 ...
 */
(function(f){function e(h){var k=h.skinDir+"/"+h.skin,l=p[k];if(l)l.loaded?a.call(this,h,l.html):l.queue.push({c:this,s:h});else{p[k]={loaded:false,queue:[{c:this,s:h}]};f.ajax({url:k+".html",dataType:"text",success:function(m){var q=p[k];q.loaded=true;q.html=m;for(m=0;m<q.queue.length;m++)a.call(q.queue[m].c,q.queue[m].s,q.html)},dataFilter:function(m){return m=m.substring(m.indexOf("<body>")+6,m.lastIndexOf("</body>"))},error:function(){if(h.error){var m=f.Event("tn3_error");m.description="tn3 skin load error";
h.error(m)}}})}return this}function a(h,k){this.each(function(){for(var l=f(this),m,q,r=k.indexOf("<img src=");r!=-1;){r+=10;q=k.indexOf('"',r);m=h.skinDir+"/"+k.substring(r,q);k=k.substr(0,r)+m+k.substr(q);r=k.indexOf("<img src=",r)}l.append(k);l.data("tn3").init(l,h.fullOnly)})}function b(h){var k=[],l=h.children(".tn3.album"),m,q;if(l.length>0)l.each(function(r){m=f(this);k[r]={title:m.find(":header").html()};f.extend(k[r],c(m));if(q=d(m)){k[r].imgs=q;if(!k[r].thumb)k[r].thumb=k[r].imgs[0].thumb}});
else if(q=d(h))k[0]={imgs:q};return k}function d(h){var k=[],l,m,q;l=h.find("li");if(l.length>0)l.each(function(r){m=f(this);q=m.find(":header");k[r]={title:q.html(),img:m.find("a").attr("href"),thumb:m.find("a img").attr("src")};if(!k[r].img)k[r].img=m.find("img").attr("src");f.extend(k[r],c(m))});else{l=h.find("img");l.each(function(r){m=f(this);$at=m.parent("a");k[r]=$at.length==0?{title:m.attr("title"),img:m.attr("src")}:{title:m.attr("title"),img:$at.attr("href"),thumb:m.attr("src")}})}if(k.length==
0)return null;return k}function c(h){var k={};h=h.children(".tn3");var l;f.each(h,function(){l=f(this);k[l.attr("class").substr(4)]=l.html()});return k}function g(h){f('a[href^="#tn3-'+h+'"]').click(function(k){var l=j[h];k=f(k.currentTarget).attr("href");k=k.substr(k.indexOf("-",5)+1);k=k.split("-");switch(k[0]){case "next":l.cAlbum!=null&&l.show("next",k[1]=="fs");break;case "prev":l.cAlbum!=null&&l.show("prev",k[1]=="fs");break;default:l.cAlbum!=parseInt(k[0])?l.showAlbum(parseInt(k[0]),parseInt(k[1]),
k[2]=="fs"):l.show(parseInt(k[1]),k[2]=="fs")}})}function i(){if(j.length==0){var h=f(".tn3gallery");h.length>0&&h.tn3({})}}if(/1\.(0|1|2|3|4)\.(0|1)/.test(f.fn.jquery)||/^1.1/.test(f.fn.jquery)||/^1.2/.test(f.fn.jquery)||/^1.3/.test(f.fn.jquery))alert("tn3gallery requires jQuery v1.4.2 or later!  You are using v"+f.fn.jquery);else{var p={},j=[];f.fn.tn3=function(h){h=f.extend(true,{},f.fn.tn3.config,h);if(h.skin!=null)if(typeof h.skin=="object"){h.skinDir+="/"+h.skin[0];if(h.cssID==null)h.cssID=
h.skin[0];h.skin=h.skin[1]}else h.skinDir+="/"+h.skin;else{h.skin="tn3";h.skinDir+="/tn3";var k=true}if(h.cssID==null)h.cssID=h.skin==null?"tn3":h.skin;this.each(function(){var l=f(this);h.fullOnly?l.hide():l.css("visibility","hidden");var m=h.data?h.data:b(l);m=j.push(new f.fn.tn3.Gallery(m,h))-1;l.data("tn3",j[m]);for(var q=0;q<f.fn.tn3.plugins.length;q++)f.fn.tn3.plugins[q].init(l,h);l.empty();g(m)});k?a.call(this,h,h.skinDefault):e.call(this,h);return this};f.fn.tn3.plugins=[];f.fn.tn3.plugIn=
function(h,k){f.fn.tn3.plugins.push({id:h,init:k})};f.fn.tn3.version="1.1.0.28";f.fn.tn3.config={data:null,skin:null,skinDir:"skins",skinDefault:'<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img src="preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
...
{width:this.$tn3.width(),height:this.$tn3.height()};this.$tn3.css("float","left");d.wDif=this.$tn3.outerWidth(true)-d.width;d.hDif=this.$tn3.outerHeight(true)-d.height;this.config.mouseWheel&&this.initMouseWheel();var c=this;this.timer=new f.fn.tn3.Timer(this.$c,this.config.delay,this.config.timerSteps);this.$c.bind("timer_end",function(){c.show("next")});this.special={rv:[],rh:[],v:[],h:[],o:[]};this.parseLayout();this.center();f.each(this.items,function(g,i){switch(g){case "next":i.click(function(j){c.show("next");
j.stopPropagation()});i.attr("title",c.t("Next Image"));break;case "prev":i.click(function(j){c.show("prev");j.stopPropagation()});i.attr("title",c.t("Previous Image"));break;case "next-page":i.click(function(){c.items.thumbs&&c.thumbnailer.next(true)});i.attr("title",c.t("Next Page"));break;case "prev-page":i.click(function(){c.items.thumbs&&c.thumbnailer.prev(true)});i.attr("title",c.t("Previous Page"));break;case "thumbs":c.config.thumbnailer.cssID=c.config.cssID;c.config.thumbnailer.initValues=
{width:i.width(),height:i.height()};c.config.thumbnailer.initValues.vertical=i.width()<=i.height();i.bind("tn_click",function(j){c.show(j.n)}).bind("tn_over",function(){c.timer.pause(true)}).bind("tn_out",function(){c.timer.pause(false)}).bind("tn_error",function(j){c.trigger("error",j)});break;case "image":c.config.image.cssID=c.config.cssID;c.config.image.initValues={width:i.width(),height:i.height()};i.bind("img_click",function(j){switch(c.config.imageClick){case "next":c.show("next");break;case "fullscreen":c.fullscreen();
...
j)});break;case "preloader":i.hide();break;case "timer":var p=i.width()>i.height()?"width":"height";c.$c.bind("timer_tick",function(j){if(c.config.timerMode=="char"){for(var h=c.config.timerStepChar;--j.tick;)h+=c.config.timerStepChar;c.items.timer.html(h)}else c.items.timer[p](c.timerSize/j.totalTicks*j.tick);c.trigger(j.type,j)}).bind("timer_start",function(j){c.timerSize=c.$inImage[p]();c.items.timer.fadeIn(300);c.trigger(j.type,j)}).bind("timer_end timer_stop",function(){c.items.timer.hide()});
i.hide();break;case "play":i.click(function(j){if(c.timer.runs){c.timer.stop();c.config.autoplay=false;i.removeClass(c.config.cssID+"-play-active");i.attr("title",c.t("Start Slideshow"))}else{c.timer.start();c.config.autoplay=true;i.addClass(c.config.cssID+"-play-active");i.attr("title",c.t("Stop Slideshow"))}j.stopPropagation()});i.attr("title",c.t("Start Slideshow"));c.config.autoplay&&i.click();break;case "albums":c.albums=new f.fn.tn3.Albums(c.data,i,c.config.cssID);i.hide();i.bind("albums_binit",
function(j){c.trigger(j.type,j)}).bind("albums_click",function(j){c.showAlbum(j.n);c.trigger(j.type,j)}).bind("albums_init",function(j){c.timer.stop();c.trigger(j.type,j)}).bind("albums_error",function(j){c.trigger("error",j)});break;case "albums-next":c.albums&&c.albums.setControl("next",i);i.attr("title",c.t("Next Album Page"));break;case "albums-prev":c.albums&&c.albums.setControl("prev",i);i.attr("title",c.t("Previous Album Page"));break;case "albums-close":c.albums&&c.albums.setControl("close",
i);i.attr("title",c.t("Close"));break;case "show-albums":i.click(function(j){c.items.albums&&c.albums.show(0,c.cAlbum);j.stopPropagation()});i.attr("title",c.t("Album List"));break;case "fullscreen":i.click(function(j){c.fullscreen();j.stopPropagation()});i.attr("title",c.t("Maximize"))}});if(this.config.width!==null||this.config.height!==null){if(this.config.width==null)this.config.width=this.config.initValues.width;if(this.config.height==null)this.config.height=this.config.initValues.height;this.resize(this.config.width,
this.config.height)}d=Math.min(this.config.iniAlbum,this.data.length-1);this.initialized=true;this.config.startWithAlbums&&this.data.length>1&&this.items.albums?this.albums.show():this.showAlbum(d,this.config.iniImage);this.config.isFullScreen&&this.onFullResize(f(window).width(),f(window).height());this.trigger("init")}},parseLayout:function(){var a=this.items={},b=this.config,d=b.active,c=b.cssID.length+1,g=this,i,p;this.$c.find("div[class^='"+b.cssID+"-']").each(function(){i=f(this);p=i.attr("class").split(" ")[0].substr(c);
if(d.length==0||f.inArray(p,d)!=-1)a[p]=i;else p!="gallery"&&i.remove();if(i.parent().hasClass(b.cssID+"-image")){if(!g.$inImage){g.$inImage=i.parent().append('<div class="tn3-in-image"></div>').find(":last");if(f.browser.msie){var j=f("<div />");j.css("background-color","#fff").css("opacity",0).css("width","100%").css("height","100%");j.appendTo(g.$inImage)}g.$inImage.css("position","absolute").width(a.image.width()).height(a.image.height())}i.appendTo(g.$inImage)}this.className.indexOf("tn3_")!=
-1&&g.addSpecial(p,this.className)})},addSpecial:function(a,b){for(var d=b.split(" "),c,g=0;g<d.length;g++){c=d[g].split("_");if(c[0]=="tn3"){this.special[c[1]].push(a);if(c[1]=="rh"||c[1]=="rv")this.config.initValues[a]={w:this.items[a].width(),h:this.items[a].height()}}}},initHover:function(a,b){var d=this;a.hover(function(){a.addClass(d.config.cssID+"-"+b+"-over")},function(){a.removeClass(d.config.cssID+"-"+b+"-over")})},setTextValues:function(a,b){var d,c,g,i=b+"-";for(g in this.items)if(g.indexOf(i)==
0){d=g.substr(i.length);if(d!="info"&&d!="prev"&&d!="next"){c=b=="image"?this.data[this.cAlbum].imgs[this.n]:this.data[this.cAlbum];if(!(!c||c[d]==undefined)){c[d]=f.trim(c[d]);d={field:d,text:c[d],data:c};this.trigger("set_text",d);if(a||d.text==undefined||d.text.length==0){this.items[g].html("");this.items[g].hide()}else{this.items[g].html(d.text);this.items[g].show()}}}}},show:function(a,b){this.timer.stop();this.imager&&this.imager.show(a);b&&this.fullscreen()},setAlbumData:function(a,b){if(b)this.trigger("error",
{description:b});else{for(var d=0,c=a.length;d<c;d++)this.data.push(a[d]);this.$c&&this.init(this.$c,this.config.fullOnly)}},setImageData:function(a,b,d){if(d)this.trigger("error",{description:d});else{a={data:a};this.trigger("image_data",a);this.data[b].imgs=a.data;this.cAlbum==b&&this.rebuild(a.data)}},showAlbum:function(a,b,d){if(this.initialized){if(a>this.data.length)return;this.timer.stop();this.cAlbum=a;if(this.data[this.cAlbum].imgs===undefined)this.loader?this.loader.getImages(this.data[this.cAlbum].adata,
this.cAlbum):this.trigger("error",{description:"Wrong album id"});else this.rebuild(this.data[this.cAlbum].imgs,b);this.albums&&this.albums.hide();this.items.preloader&&this.items.preloader.show()}else{this.config.iniAlbum=a;this.config.iniImage=b;this.init(this.$c,false)}d&&this.fullscreen()},rebuild:function(a,b){if(this.items.thumbs)if(this.thumbnailer)this.thumbnailer.rebuild(a);else this.thumbnailer=new f.fn.tn3.Thumbnailer(this.items.thumbs,a,this.config.thumbnailer);if(this.items.image)if(this.imager)this.imager.rebuild(a);
...
this));this.config.fullOnly&&this.$c.show();this.config.isFullScreen=true;if(this.items.fullscreen){this.items.fullscreen.addClass(this.config.cssID+"-fullscreen-active");this.items.fullscreen.attr("title",this.t("Minimize"))}this.onFullResize();e=this;f(document).bind("keyup",this.onEscape);this.trigger("fullscreen",{fullscreen:true})}},onEscape:function(a){a.keyCode==27&&e.fullscreen();a.keyCode==39&&e.show("next");a.keyCode==37&&e.show("prev");a.keyCode==38&&e.items.albums&&e.albums.show(0,e.cAlbum);
a.keyCode==40&&e.albums.hide()},onFullResize:function(){var a=f(window),b=a.width();a=a.height();b-=this.config.initValues.wDif;a-=this.config.initValues.hDif;this.resize(b,a)},resize:function(a,b){this.$tn3.width(a).height(b);var d=a-this.config.initValues.width,c=b-this.config.initValues.height,g,i,p=this;if(this.items.image){g=this.config.image.initValues.width+d;i=this.config.image.initValues.height+c;if(this.imager)this.imager.setSize(g,i);else{this.items.image.width(g).height(i);this.$inImage.width(g).height(i)}}if(this.items.thumbs){g=
this.config.thumbnailer.initValues.width+d;i=this.config.thumbnailer.initValues.height+c;if(this.thumbnailer)this.thumbnailer.setSize(g,i);else this.config.thumbnailer.initValues.vertical?this.items.thumbs.height(i):this.items.thumbs.width(g)}if(this.items.albums){g=this.albums.initValues.width+d;i=this.albums.initValues.height+c;this.albums.changeSize(d,c)}f.each(this.special.rh,function(j,h){p.items[h].width(p.config.initValues[h].w+d)});f.each(this.special.rv,function(j,h){p.items[h].height(p.config.initValues[h].h+
c)});this.center()},center:function(){var a,b=this;f.each(this.special.v,function(d,c){a=b.items[c];a.css("top",(a.parent().height()-a.height())/2)});f.each(this.special.h,function(d,c){a=b.items[c];a.css("left",(a.parent().width()-a.width())/2)})},trigger:function(a,b){var d=f.Event("tn3_"+a),c;for(c in b)d[c]=b[c];if(b&&b.type!=undefined)d.type="tn3_"+a;d.source=this;this.$c.trigger(d);this.config[a]&&this.config[a].call(this,d);for(c in b)b[c]=d[c]},initMouseWheel:function(){var a=this,b=function(d){a.show((d.detail?
-d.detail:d.wheelDelta)>0?"prev":"next");d.preventDefault()};this.$tn3.bind("mousewheel",b);this.$tn3.bind("DOMMouseScroll",b)},replaceMenu:function(a,b){var d='<div style="position:absolute;background-color:#fff;color: #000;padding:0px 4px 0px 4px;z-index:1010;font-family:sans-serif;font-size:12px;">&copy; <a href="'+b+'">'+a+"</a></div>";this.$tn3.bind("contextmenu",function(c){c.preventDefault()}).bind("mousedown",function(c){if(c.which==3){var g=f("body").append(d).find("div:last");g.css("left",
c.pageX).css("top",c.pageY);g.find("a").mouseup(function(i){window.location=b;g.unbind(i)});f("body").mouseup(function(i){g.remove();f("body").unbind(i)})}})}}})(jQuery);
...
$cur.hide();$cur=this.$a.clone();$cur.appendTo(this.$in);a+=this.aw+this.space}b+=this.ah+this.space;a=this.pad}$cur.remove();return e},show:function(e,a,b){this.$c.show();if(e==undefined)e=0;else if(e=="next")e=this.n+1<this.data.length?this.n+1:0;else if(e=="prev")e=this.n>0?this.n-1:this.data.length-1;if(a!=undefined)this.selected=a;var d,c,g=this.getButtons(),i=this;a=e*g.length;var p=Math.min(this.data.length,(e+1)*g.length);this.trigger("init");for(var j=a;j<p;j++){var h=this.data[j];if(!h.title)h.title=
"Unknown";d=g[j-a];c='<div class="'+this.cssID+'-album-image"></div>';c+='<div class="'+this.cssID+'-album-title">'+h.title+"</div>";if(h.description)c+='<div class="'+this.cssID+'-album-description">'+h.description+"</div>";d.html(c);new f.fn.tn3.ImageLoader(h.thumb,this,this.onThumbLoad,[d.find("."+this.cssID+"-album-image")]);d.data("tn3",j);this.trigger("binit",{$a:d});if(j!=this.selected)d.click(function(){i.trigger("click",{n:f(this).data("tn3")})}).hover(function(){f(this).addClass(i.cssID+
"-album-over")},function(){f(this).removeClass(i.cssID+"-album-over")});else{d.addClass(this.cssID+"-album-selected");d.unbind("click mouseenter mouseleave")}}d=j%g.length;if(d!=0)for(c=g.length-1;c>=d;c--)g.splice(c,1);this.n=e;if(b)f.each(g,function(l){g[l].show()});else{var k=800/g.length;this.$c.slideDown(e==0?300:0,function(){f.each(g,function(l){g[l].delay(l*k).fadeIn(150)})})}this.ctrl_prev&&this.enablePageControl("prev",a>0);this.ctrl_next&&this.enablePageControl("next",p<this.data.length)},
...
(function(f){var e=f.fn.tn3.Transitions=function(b,d,c,g,i){this.ts=b;this.def=f.extend(true,{},this[d.type+"Config"],d);if(!b)this.ts=[this.def];for(var p in this.ts)this.ts[p]=f.extend(true,{},this[this.ts[p].type+"Config"],this.ts[p]);this.random=c;this.end=f.proxy(g,i)},a=e.prototype={ts:null,def:{type:"slide"},random:false,gs:[],end:null,ct:null,counter:-1,setTransition:function(){if(this.ts.length==1)this.ct=this.ts[0];else{this.counter++;if(this.counter==this.ts.length)this.counter=0;this.random&&
this.counter==0&&f.fn.tn3utils.shuffle(this.ts);this.ct=this.ts[this.counter]}},start:function(b,d,c){this.setTransition();if(this[this.ct.type+"Condition"]!==undefined&&!this[this.ct.type+"Condition"](b,d,this.ct))this.ct=this.def;this[this.ct.type](b,d,this.ct,c)},stop:function(b,d){this[this.ct.type+"Stop"](b,d,this.ct)},makeGrid:function(b,d,c){var g=b.width(),i=Math.round(g/d);g=g-i*d;var p=b.height(),j=Math.round(p/c);p=p-j*c;var h,k,l,m,q,r=0,s=0,u="url("+b.find("img").attr("src")+") no-repeat scroll -";
for(h=0;h<d;h++){this.gs[h]=[];m=g>h?i+1:i;for(k=0;k<c;k++){l=b.append("<div></div>").find(":last");q=p>k?j+1:j;l.width(m).height(q).css("background",u+r+"px -"+s+"px").css("left",r).css("top",s).css("position","absolute");this.gs[h].push(l);s+=q}r+=m;s=0}b.find("img").remove()},stopGrid:function(){for(var b=0;b<this.gs.length;b++)for(var d=0;d<this.gs[b].length;d++){this.gs[b][d].clearQueue();this.gs[b][d].remove()}this.gs=[]},flatSort:function(b){for(var d=[],c=0;c<this.gs.length;c++)for(var g=
0;g<this.gs[c].length;g++)d.push(this.gs[c][g]);b&&d.reverse();return d},randomSort:function(){var b=this.flatSort();f.fn.tn3utils.shuffle(b);return b},diagonalSort:function(b,d){for(var c=[],g=b>0?this.gs.length-1:0,i=d>0?0:this.gs[0].length-1;this.gs[g];){c.push(this.addDiagonal([],g,i,b,d));g-=b}g+=b;for(i+=d;this.gs[g][i];){c.push(this.addDiagonal([],g,i,b,d));i+=d}return c},addDiagonal:function(b,d,c,g,i){b.push(this.gs[d][c]);return this.gs[d+g]&&this.gs[d+g][c+i]?this.addDiagonal(b,d+g,c+i,
g,i):b},circleSort:function(b){var d=[],c=this.gs.length,g=this.gs[0].length,i=[Math.floor(c/2),Math.floor(g/2)];c=c*g;g=[[1,0],[0,1],[-1,0],[0,-1]];var p=0,j=0,h;for(d.push(this.gs[i[0]][i[1]]);d.length<c;){for(h=0;h<=p;h++)this.addGridPiece(d,i,g[j]);if(j==g.length-1)j=0;else j++;p+=0.5}b&&d.reverse();return d},addGridPiece:function(b,d,c){d[0]+=c[0];d[1]+=c[1];this.gs[d[0]]&&this.gs[d[0]][d[1]]&&b.push(this.gs[d[0]][d[1]])},getSlidePositions:function(b,d){var c={dir:d};switch(d){case "left":c.pos=
b.outerWidth(true);break;case "right":c.pos=-b.outerWidth(true);c.dir="left";break;case "top":c.pos=-b.outerHeight(true);break;case "bottom":c.pos=b.outerHeight(true);c.dir="top"}return c},animateGrid:function(b,d,c,g,i,p,j){var h={duration:g,easing:c,complete:function(){f(this).remove()}};for(c=0;c<b.length;c++){g=f.easing[i](0,c,0,p,b.length);if(c==b.length-1){var k=this;h.complete=function(){f(this).remove();j.call(k)}}if(f.isArray(b[c]))for(var l in b[c])b[c][l].delay(g).animate(d[c],h);else b[c].delay(g).animate(d[c],
h)}},getValueArray:function(b,d,c){var g=[],i=f.isArray(d),p=f.isArray(c),j;for(j=0;j<b;j++){o={};o[i?d[j%d.length]:d]=p?c[j%c.length]:c;g.push(o)}return g}};e.defined=[];e.define=function(b){for(var d in b)switch(d){case "type":e.defined.push(b.type);break;case "config":a[b.type+"Config"]=b.config;break;case "f":a[b.type]=b.f;break;case "stop":a[b.type+"Stop"]=b.stop;break;case "condition":a[b.type+"Condition"]=b.condition;break;default:a[d]=b[d]}};e.define({type:"none",config:{},f:function(){this.end()},
stop:function(){this.end()}});e.define({type:"fade",config:{duration:300,easing:"easeInQuad"},f:function(b,d,c){var g=this;b.animate({opacity:0},c.duration,c.easing,function(){g.end()})},stop:function(b){b.stop();this.end()}});e.define({type:"slide",config:{duration:300,direction:"auto",easing:"easeInOutCirc"},f:function(b,d,c,g){g=this.getSlidePositions(d,c.direction=="auto"?g:c.direction);var i={},p={};d.css(g.dir,g.pos);i[g.dir]=0;d.animate(i,c.duration,c.easing,this.end);p[g.dir]=-g.pos;b.animate(p,
c.duration,c.easing)},stop:function(b,d){d.stop();b.stop();b.css("left",0).css("top",0);d.css("left",0).css("top",0);this.end()}});e.define({type:"blinds",config:{duration:240,easing:"easeInQuad",direction:"vertical",parts:12,partDuration:100,partEasing:"easeInQuad",method:"fade",partDirection:"auto",cross:true},f:function(b,d,c,g){c.direction=="horizontal"?this.makeGrid(b,1,c.parts):this.makeGrid(b,c.parts,1);g=c.partDirection=="auto"?g:c.partDirection;b=this.flatSort(g=="left"||g=="top");var i;
switch(c.method){case "fade":i=this.getValueArray(b.length,"opacity",0);break;case "scale":i=this.getValueArray(b.length,g=="left"?"width":"height","1px");break;case "slide":d=this.getSlidePositions(d,g);i=this.getValueArray(b.length,d.dir,c.cross?[d.pos,-d.pos]:d.pos)}this.animateGrid(b,i,c.partEasing,c.partDuration,c.easing,c.duration,this.blindsStop)},stop:function(){this.stopGrid();this.end()},condition:function(b,d){return!b.data("scaled")||!d.data("scaled")}});e.define({type:"grid",config:{duration:260,
easing:"easeInQuad",gridX:7,gridY:5,sort:"diagonal",sortReverse:false,diagonalStart:"bl",method:"fade",partDuration:300,partEasing:"easeOutSine",partDirection:"left"},f:function(b,d,c,g){this.makeGrid(b,c.gridX,c.gridY);b=c.partDirection=="auto"?g:c.partDirection;var i,p;if(c.sort=="diagonal")switch(c.diagonalStart){case "tr":i=this.diagonalSort(1,1);break;case "tl":i=this.diagonalSort(-1,1);break;case "br":i=this.diagonalSort(1,-1);break;case "bl":i=this.diagonalSort(-1,-1)}else i=this[c.sort+"Sort"](c.sortReverse);
switch(c.method){case "fade":p=this.getValueArray(i.length,"opacity",0);break;case "scale":p=this.getValueArray(i.length,b=="left"?"width":"height","1px")}this.animateGrid(i,p,c.partEasing,c.partDuration,c.easing,c.duration,this.gridStop)},stop:function(){this.stopGrid();this.end()},condition:function(b,d){return!b.data("scaled")||!d.data("scaled")}})})(jQuery);
(function(f){function e(h){var k=h&&h.message!==undefined?h.message:undefined;h=f.extend({},f.tn3block.defaults,h||{});k=k===undefined?h.message:k;j&&a({});var l=h.baseZ,m=f.browser.msie||h.forceIframe?f('<iframe class="blockUI" style="z-index:'+l++ +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'+h.iframeSrc+'"></iframe>'):f('<div class="blockUI" style="display:none"></div>'),q=f('<div class="blockUI '+h.cssID+'-overlay" style="z-index:'+
l++ +';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');l=f('<div class="blockUI '+h.blockMsgClass+' blockPage" style="z-index:'+l+';display:none;position:fixed"></div>');l.css("left","0px").css("top","0px");if(!h.applyPlatformOpacityRules||!(f.browser.mozilla&&/Linux/.test(navigator.platform)))q.css(h.overlayCSS);q.css("position","fixed");if(f.browser.msie||h.forceIframe)m.css("opacity",0);var r=[m,q,l],s=f("body");f.each(r,function(){this.appendTo(s)});r=
i&&(!f.boxModel||f("object,embed",null).length>0);if(p||r){h.allowBodyStretch&&f.boxModel&&f("html,body").css("height","100%");f.each([m,q,l],function(u,v){var t=v[0].style;t.position="absolute";if(u<2){t.setExpression("height","Math.max(document.body.scrollHeight, document.body.offsetHeight)- (jQuery.boxModel?0:"+h.quirksmodeOffsetHack+') + "px"');t.setExpression("width",'jQuery.boxModel && document.documentElement.clientWidth || document.body.clientWidth + "px"')}else if(h.centerY){t.setExpression("top",
...
h.showOverlay)m.show();h.showOverlay&&q.show();k&&l.show();h.onBlock&&h.onBlock();d(1,h);j=k}function a(h){h=f.extend({},f.tn3block.defaults,h||{});d(0,h);var k=f("body").children().filter(".blockUI").add("body > .blockUI");b(k,h)}function b(h,k){h.each(function(){this.parentNode&&this.parentNode.removeChild(this)});j.data("blockUI.parent").append(j);j=null;typeof k.onUnblock=="function"&&k.onUnblock.call(k.con)}function d(h,k){if(h||j)!k.bindEvents||h&&!k.showOverlay||(h?f(document).bind("mousedown mouseup keydown keypress",
k,c):f(document).unbind("mousedown mouseup keydown keypress",c))}function c(h){var k=h.data;if(f(h.target).parents("div."+k.blockMsgClass).length>0)return true;return f(h.target).parents().children().filter("div.blockUI").length==0}var g=document.documentMode||0,i=f.browser.msie&&(f.browser.version<8&&!g||g<8),p=f.browser.msie&&/MSIE 6.0/.test(navigator.userAgent)&&!g;f.tn3block=function(h){e(h)};f.tn3unblock=function(h){a(h)};var j=undefined;f.tn3block.defaults={message:"<h1>Please wait...</h1>",
...
[],d=this,c,g,i;f(a).find(":first").children().each(function(j,h){c=f(this);b[j]={};b[j].adata={id:j,origin:d};g=c.find("file_root").text();d.setProps(h,b[j],g);b[j].imgs=[];delete b[j].images;c.find("images > image").each(function(k,l){i=b[j].imgs[k]={};d.setProps(l,i,g)})})}catch(p){this.extcon.setAlbumData([],"XML parsing error")}return b},setProps:function(a,b,d){var c;f(a).children().each(function(g,i){if(i.firstChild){c=i.firstChild.nodeValue;n=i.tagName;if(n.substring(n.length-3)=="src"){c=
